...
public partial class SicaContext : DbContext
{
    ...
    public virtual DbSet<EbasecaPrueba> EbasecaPrueba { get; set; }
    ...
    public virtual DbSet<SitiosFinalFiltros1> SitiosFinalFiltros1 { get; set; }
    ...
    public virtual DbSet<_2012> _2012 { get; set; }

    public virtual DbSet<_2013> _2013 { get; set; }

    public virtual DbSet<_2014> _2014 { get; set; }

    public virtual DbSet<_2015> _2015 { get; set; }

    public virtual DbSet<_2016> _2016 { get; set; }

    public virtual DbSet<_2017> _2017 { get; set; }

    public virtual DbSet<_2018> _2018 { get; set; }

    public virtual DbSet<_2019> _2019 { get; set; }

    public virtual DbSet<_2020> _2020 { get; set; }

    public virtual DbSet<_2021> _2021 { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EbasecaPrueba>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ebaseca_PRUEBA$");

            entity.Property(e => e.AnioOperacion).HasMaxLength(255);
            entity.Property(e => e.ClaveConagua)
                .HasMaxLength(255)
                .HasColumnName("CLAVE CONAGUA");
            entity.Property(e => e.ClaveConalab)
                .HasMaxLength(255)
                .HasColumnName("Clave CONALAB");
            entity.Property(e => e.ClaveParametro).HasMaxLength(255);
            entity.Property(e => e.FechaEntrega).HasColumnType("datetime");
            entity.Property(e => e.FechaProgramadaVisita).HasColumnType("datetime");
            entity.Property(e => e.FechaRealVisita).HasColumnType("datetime");
            entity.Property(e => e.GrupoDeParametro)
                .HasMaxLength(255)
                .HasColumnName("Grupo de Parametro");
            entity.Property(e => e.HoraFinMuestreo).HasColumnType("datetime");
            entity.Property(e => e.HoraInicioMuestreo).HasColumnType("datetime");
            entity.Property(e => e.LaboratorioBaseDeDatos)
                .HasMaxLength(255)
                .HasColumnName("Laboratorio Base de Datos");
            entity.Property(e => e.LaboratorioRealizoMuestreo).HasMaxLength(255);
            entity.Property(e => e.LaboratorioSubrogado)
                .HasMaxLength(255)
                .HasColumnName("Laboratorio Subrogado");
            entity.Property(e => e.Ldmlaboratorio)
                .HasMaxLength(255)
                .HasColumnName("LDMLaboratorio");
            entity.Property(e => e.Lpclaboratorio)
                .HasMaxLength(255)
                .HasColumnName("LPCLaboratorio");
            entity.Property(e => e.Muestreo).HasMaxLength(255);
            entity.Property(e => e.NoEntrega).HasColumnName("No# Entrega");
            entity.Property(e => e.NoVecesLiberadoConagua)
                .HasMaxLength(255)
                .HasColumnName("NoVecesLiberadoCONAGUA");
            entity.Property(e => e.ObservacionesConagua).HasMaxLength(255);
            entity.Property(e => e.ObservacionesConagua2).HasMaxLength(255);
            entity.Property(e => e.ObservacionesConagua3).HasMaxLength(255);
            entity.Property(e => e.ObservacionesLaboratorio)
                .HasMaxLength(255)
                .HasColumnName("Observaciones Laboratorio");
            entity.Property(e => e.Parametro).HasMaxLength(255);
            entity.Property(e => e.PrecioDeParametro)
                .HasMaxLength(255)
                .HasColumnName("Precio de Parametro");
            entity.Property(e => e.Resultado).HasMaxLength(255);
            entity.Property(e => e.SubgrupoParametro).HasMaxLength(255);
            entity.Property(e => e.SubtipoCuerpoAgua).HasMaxLength(255);
            entity.Property(e => e.TipoDeCuerpoDeAgua)
                .HasMaxLength(255)
                .HasColumnName("Tipo de Cuerpo de Agua");
            entity.Property(e => e.UnidadMedida).HasMaxLength(255);
        });
        ...
        modelBuilder.Entity<Muestreo>(entity =>
        {
            ...
            entity.Property(e => e.EstatusSecaia)
                .HasComment("Campo que indica el estatus referente a revisión de SECAIA")
        ...
        modelBuilder.Entity<ResultadoMuestreo>(entity =>
        {
            ...
            entity.Property(e => e.FechaObservacionSrenameca)
                .HasComment("Campoq eu indica la fecha en la que se realizaron las observaciones por parte de SRENAMECA")
                .HasColumnType("datetime")
            ...
            entity.Property(e => e.ObservacionLaboratorio)
                .IsUnicode(false)
                .HasComment("Campoq ue describe las observaciones por parte del laboratorio");
        ...
        modelBuilder.Entity<SitiosFinalFiltros1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("SitiosFinalFiltros1$");

            entity.Property(e => e.Acuífero)
                .HasMaxLength(255)
                .HasColumnName("ACUÍFERO");
            entity.Property(e => e.ClaveAcuífero).HasColumnName("CLAVE ACUÍFERO");
            entity.Property(e => e.ClaveSitioBasePublicada1223)
                .HasMaxLength(255)
                .HasColumnName("CLAVE SITIO BASE PUBLICADA 12-23");
            entity.Property(e => e.Cuenca)
                .HasMaxLength(255)
            ...
            entity.Property(e => e.NombreDelSitioBasePublicada1223)
                .HasMaxLength(255)
                .HasColumnName("NOMBRE DEL SITIO BASE PUBLICADA 12-23");
            entity.Property(e => e.OrganismoCuenca)
                .HasMaxLength(255)
        ...
        modelBuilder.Entity<_2012>(entity =>
        {
            ...
            entity.Property(e => e.Acuífero)
                .HasMaxLength(255)
                .HasColumnName("ACUÍFERO");
            entity.Property(e => e.BrigadaMuestreo).HasMaxLength(255);
            entity.Property(e => e.ClaveAcuífero)
                .HasMaxLength(255)
                .HasColumnName("CLAVE ACUÍFERO");
            entity.Property(e => e.ClaveSitio)
            ...
            entity.Property(e => e.Cuenca)
                .HasMaxLength(255)
                .HasColumnName("CUENCA");
            entity.Property(e => e.CuencaRevision).HasMaxLength(255);
            entity.Property(e => e.CuerpoDeAgua)
                .HasMaxLength(255)
                .HasColumnName("CUERPO DE AGUA");
            entity.Property(e => e.DiaProgramado).HasColumnType("datetime");
            entity.Property(e => e.DireccionLrevision)
                .HasMaxLength(255)
                .HasColumnName("DireccionLRevision");
            entity.Property(e => e.DirecciónLocal)
                .HasMaxLength(255)
                .HasColumnName("DIRECCIÓN LOCAL");
            entity.Property(e => e.DomingoSemanaProgramada).HasColumnType("datetime");
            entity.Property(e => e.Estado)
                .HasMaxLength(255)
                .HasColumnName("ESTADO");
            entity.Property(e => e.Laboratorio)
            ...
            entity.Property(e => e.LaboratorioSiglas)
                .HasMaxLength(255)
                .HasColumnName("LABORATORIO SIGLAS");
            entity.Property(e => e.Latitud).HasColumnName("LATITUD");
            entity.Property(e => e.Longitud).HasColumnName("LONGITUD");
            entity.Property(e => e.Municipio)
                .HasMaxLength(255)
                .HasColumnName("MUNICIPIO");
            entity.Property(e => e.NombreCorrectoArchivo).HasMaxLength(255);
            entity.Property(e => e.NombreDelSitio)
                .HasMaxLength(255)
                .HasColumnName("NOMBRE DEL SITIO");
            entity.Property(e => e.NumDeMuestreosRealizadosProAño)
                .HasMaxLength(255)
                .HasColumnName("Num de muestreos realizados pro año");
            ...
            entity.Property(e => e.TipoDeCuerpoDeAgua)
                .HasMaxLength(255)
                .HasColumnName("TIPO DE CUERPO DE AGUA");
            entity.Property(e => e.TipoSitio)
                .HasMaxLength(255)
                .HasColumnName("Tipo sitio");
        });
