...
namespace Persistence
{
    public static class ServiceExtensions
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration, string environment)
        {
            ...
            services.AddTransient<IRepository<LimiteParametroLaboratorio>, LimiteParametroLaboratorioRepository>();
            ...
            services.AddTransient<IVwOrganismosDireccionesRepository, VwOrganismosDireccionesRepository>();
            ...
            services.AddTransient<IAvisoRealizacionRepository, AvisoRealizacionRepository>();
