        ...
        public async Task<IEnumerable<InformacionEvidenciaDto>> GetInformacionEvidenciasAsync()
        {
            ...
            if (informacionEvidencias.Any())
            {
                informacionEvidenciaDtos = await informacionEvidencias.Select(x => new InformacionEvidenciaDto
                {
                    ...
                    FechaCreacion = x.FechaCreacion == null ? string.Empty : x.FechaCreacion.Value.ToString("dd/MM/yyyy"),
                    HoraCreacion = x.FechaCreacion == null ? string.Empty : x.FechaCreacion.Value.ToString("hh:mm:ss"),
                    ...
                    ValidacionEvidencias = x.Muestreo.ValidacionEvidencias
                }).ToListAsync();
